...
#ifndef VIEW_SDL3_WIDGET_VERTICAL_SCROLLBAR_HPP
#define VIEW_SDL3_WIDGET_VERTICAL_SCROLLBAR_HPP
...
private:
  frect scroll_rect{};
  f32 real_height = 0.0F;
  f32 max_offset = 0.0F;

  void adjust_heights() noexcept;
};
